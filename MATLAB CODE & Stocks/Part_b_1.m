...
for fileIndex = 1:length(csvFiles)
    ...
    % Filter out dates not in the range January 2011 to June 2011
    Data_Stock_Features = Data_Stock_Features(Data_Stock_Features.Date >= datetime(2011, 1, 1) & Data_Stock_Features.Date <= datetime(2011, 6, 30), :);
